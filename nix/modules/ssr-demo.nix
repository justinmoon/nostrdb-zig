...
in {
  options.services.nostrdb-ssr = {
    ...
    package = lib.mkOption {
      ...
      default = null;
      description = "Package providing the ssr-demo binary (e.g., inputs.nostrdb-zig.packages.<system>.ssr-demo).";
    };
    ...
    assertions = [
      {
        ...
        message = "services.nostrdb-ssr.package must be set to the ssr-demo package.";
      }
    ];
